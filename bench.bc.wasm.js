...
m()})(function(a){"use strict";return{}}(globalThis))({"link":[["code-6cedbf224aec38c98574",0]],"generated":(a=>{var
b=a,c=a?.module?.export||a;return{"fragments":{"fun_call_2":(a,b,c)=>a(b,c),"get_Array":a=>a.Array,"get_ArrayBuffer":a=>a.ArrayBuffer,"get_Blob":a=>a.Blob,"get_BroadcastChannel":a=>a.BroadcastChannel,"get_ClipboardItem":a=>a.ClipboardItem,"get_DataView":a=>a.DataView,"get_Event":a=>a.Event,"get_File":a=>a.File,"get_FormData":a=>a.FormData,"get_Headers":a=>a.Headers,"get_JSON":a=>a.JSON,"get_MediaRecorder":a=>a.MediaRecorder,"get_MediaStream":a=>a.MediaStream,"get_MessageChannel":a=>a.MessageChannel,"get_Notification":a=>a.Notification,"get_Number":a=>a.Number,"get_Promise":a=>a.Promise,"get_Range":a=>a.Range,"get_RegExp":a=>a.RegExp,"get_Request":a=>a.Request,"get_Response":a=>a.Response,"get_URL":a=>a.URL,"get_URLSearchParams":a=>a.URLSearchParams,"get_Uint8Array":a=>a.Uint8Array,"get_WebSocket":a=>a.WebSocket,"get_console":a=>a.console,"get_decodeURI":a=>a.decodeURI,"get_decodeURIComponent":a=>a.decodeURIComponent,"get_document":a=>a.document,"get_documentElement":a=>a.documentElement,"get_encodeURI":a=>a.encodeURI,"get_encodeURIComponent":a=>a.encodeURIComponent,"get_fetch":a=>a.fetch,"get_firstChild":a=>a.firstChild,"get_fut":a=>a.fut,"get_isSecureContext":a=>a.isSecureContext,"get_length":a=>a.length,"get_location":a=>a.location,"get_message":a=>a.message,"get_navigator":a=>a.navigator,"get_performance":a=>a.performance,"get_search":a=>a.search,"get_window":a=>a.window,"js_expr_12c48ca8":()=>a,"js_expr_26f07992":()=>null,"js_expr_ba692c1":()=>undefined,"meth_call_0_arrayBuffer":a=>a.arrayBuffer(),"meth_call_0_blob":a=>a.blob(),"meth_call_0_now":a=>a.now(),"meth_call_1_appendChild":(a,b)=>a.appendChild(b),"meth_call_1_createTextNode":(a,b)=>a.createTextNode(b),"meth_call_1_get":(a,b)=>a.get(b),"meth_call_1_getElementById":(a,b)=>a.getElementById(b),"meth_call_1_removeChild":(a,b)=>a.removeChild(b),"meth_call_1_resolve":(a,b)=>a.resolve(b),"meth_call_1_slice":(a,b)=>a.slice(b),"meth_call_1_then":(a,b)=>a.then(b),"meth_call_2_then":(a,b,c)=>a.then(b,c),"new_1":(a,b)=>new
a(b),"new_2":(a,b,c)=>new
a(b,c),"obj_0":()=>({}),"obj_1":a=>({fut:a}),"obj_2":a=>({fut:a}),"obj_3":a=>({fut:a})}}})(globalThis),"src":"bench.bc.wasm.assets"});
